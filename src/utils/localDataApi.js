...
export const localDataApi = {
  ...
  resolveCandidateSource: (candidateId, url) => request(`/enrichment/candidates/${encodeURIComponent(candidateId)}/source-search/resolve`, { method: "POST", body: JSON.stringify({ url }) }),
