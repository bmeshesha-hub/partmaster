...
export default function MasterDataPage() {
  ...
  const templateCanRun = localServiceAvailable !== false && (selectedTemplateSupported || Boolean(templateCapabilities?.error));
  const templatePreviewMessage = publicMode
    ? (publishedCatalog ? templatePreviewError : "Loading the published catalog snapshot…")
    : localServiceAvailable === false
      ? "The local catalog service is not running. Start it with `npm run dev:local` to preview and export this template."
